...
class Detect:
    def __init__(self, model: str = "best_ncnn_model", conf: float = 0.8, datastream:bool=False) -> None:
        '''
        init detection
...
if __name__ == "__main__":  
    Detect("best_ncnn_model",datastream=True,conf=0.4).stream(camera=0,gui=True)